...
[![tests](https://img.shields.io/badge/tests-838%20passing-brightgreen)](#development)
...
by 838 tests: 815 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 815 default tests; skips tests/e2e/
