...
[![tests](https://img.shields.io/badge/tests-1216%20passing-brightgreen)](#development)
...
by 1216 tests: 1183 default unit/integration/TUI/web smoke tests plus 33
...
# Tests
uv run pytest -q                          # 1183 default tests; skips tests/e2e/
