...
[![tests](https://img.shields.io/badge/tests-978%20passing-brightgreen)](#development)
...
by 978 tests: 955 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 955 default tests; skips tests/e2e/
