...
[![tests](https://img.shields.io/badge/tests-836%20passing-brightgreen)](#development)
...
by 836 tests: 813 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 813 default tests; skips tests/e2e/
