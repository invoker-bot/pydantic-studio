...
[![tests](https://img.shields.io/badge/tests-1270%20passing-brightgreen)](#development)
...
by 1270 tests: 1219 default unit/integration/TUI/web smoke tests plus 51
...
# Tests
uv run pytest -q                          # 1219 default tests; skips tests/e2e/
