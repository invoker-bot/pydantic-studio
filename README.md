...
[![tests](https://img.shields.io/badge/tests-942%20passing-brightgreen)](#development)
...
by 942 tests: 919 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 919 default tests; skips tests/e2e/
