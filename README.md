...
[![tests](https://img.shields.io/badge/tests-982%20passing-brightgreen)](#development)
...
by 982 tests: 959 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 959 default tests; skips tests/e2e/
