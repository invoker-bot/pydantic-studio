...
[![tests](https://img.shields.io/badge/tests-1202%20passing-brightgreen)](#development)
...
by 1202 tests: 1169 default unit/integration/TUI/web smoke tests plus 33
...
# Tests
uv run pytest -q                          # 1169 default tests; skips tests/e2e/
