...
[![tests](https://img.shields.io/badge/tests-890%20passing-brightgreen)](#development)
...
by 890 tests: 867 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 867 default tests; skips tests/e2e/
