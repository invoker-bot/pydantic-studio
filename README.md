...
[![tests](https://img.shields.io/badge/tests-1156%20passing-brightgreen)](#development)
...
by 1156 tests: 1123 default unit/integration/TUI/web smoke tests plus 33
...
# Tests
uv run pytest -q                          # 1123 default tests; skips tests/e2e/
