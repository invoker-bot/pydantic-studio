...
[![tests](https://img.shields.io/badge/tests-820%20passing-brightgreen)](#development)
...
by 820 tests: 797 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 797 default tests; skips tests/e2e/
