...
[![tests](https://img.shields.io/badge/tests-835%20passing-brightgreen)](#development)
...
by 835 tests: 812 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 812 default tests; skips tests/e2e/
