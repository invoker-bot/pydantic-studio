...
[![tests](https://img.shields.io/badge/tests-1370%20passing-brightgreen)](#development)
...
by 1370 tests: 1318 default unit/integration/TUI/web smoke tests plus 52
...
# Tests
uv run pytest -q                          # 1318 default tests; skips tests/e2e/
