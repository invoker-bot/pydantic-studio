...
[![tests](https://img.shields.io/badge/tests-1089%20passing-brightgreen)](#development)
...
by 1089 tests: 1063 default unit/integration/TUI/web smoke tests plus 26
...
# Tests
uv run pytest -q                          # 1063 default tests; skips tests/e2e/
