...
[![tests](https://img.shields.io/badge/tests-884%20passing-brightgreen)](#development)
...
by 884 tests: 861 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 861 default tests; skips tests/e2e/
