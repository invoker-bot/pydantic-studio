...
[![tests](https://img.shields.io/badge/tests-1276%20passing-brightgreen)](#development)
...
by 1276 tests: 1225 default unit/integration/TUI/web smoke tests plus 51
...
# Tests
uv run pytest -q                          # 1225 default tests; skips tests/e2e/
