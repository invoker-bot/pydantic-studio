...
[![tests](https://img.shields.io/badge/tests-985%20passing-brightgreen)](#development)
...
by 985 tests: 962 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 962 default tests; skips tests/e2e/
