...
[![tests](https://img.shields.io/badge/tests-1260%20passing-brightgreen)](#development)
...
by 1260 tests: 1212 default unit/integration/TUI/web smoke tests plus 48
...
uv run python -m pytest tests/e2e -p playwright -o "addopts=-ra"    # 48 browser tests
```
