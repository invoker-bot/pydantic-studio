...
[![tests](https://img.shields.io/badge/tests-858%20passing-brightgreen)](#development)
...
by 858 tests: 835 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 835 default tests; skips tests/e2e/
