...
[![tests](https://img.shields.io/badge/tests-972%20passing-brightgreen)](#development)
...
by 972 tests: 949 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 949 default tests; skips tests/e2e/
