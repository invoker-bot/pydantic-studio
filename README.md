...
[![tests](https://img.shields.io/badge/tests-904%20passing-brightgreen)](#development)
...
by 904 tests: 881 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 881 default tests; skips tests/e2e/
