...
[![tests](https://img.shields.io/badge/tests-1318%20passing-brightgreen)](#development)
...
by 1318 tests: 1266 default unit/integration/TUI/web smoke tests plus 52
...
# Tests
uv run pytest -q                          # 1266 default tests; skips tests/e2e/
