...
[![tests](https://img.shields.io/badge/tests-829%20passing-brightgreen)](#development)
...
by 829 tests: 806 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 806 default tests; skips tests/e2e/
