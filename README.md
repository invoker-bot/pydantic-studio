...
[![tests](https://img.shields.io/badge/tests-1343%20passing-brightgreen)](#development)
...
by 1343 tests: 1291 default unit/integration/TUI/web smoke tests plus 52
...
# Tests
uv run pytest -q                          # 1291 default tests; skips tests/e2e/
