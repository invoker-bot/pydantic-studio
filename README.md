...
[![tests](https://img.shields.io/badge/tests-984%20passing-brightgreen)](#development)
...
by 984 tests: 961 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 961 default tests; skips tests/e2e/
