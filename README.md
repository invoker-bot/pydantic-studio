...
[![tests](https://img.shields.io/badge/tests-1333%20passing-brightgreen)](#development)
...
by 1333 tests: 1281 default unit/integration/TUI/web smoke tests plus 52
...
# Tests
uv run pytest -q                          # 1281 default tests; skips tests/e2e/
