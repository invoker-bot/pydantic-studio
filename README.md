...
[![tests](https://img.shields.io/badge/tests-827%20passing-brightgreen)](#development)
...
by 827 tests: 804 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 804 default tests; skips tests/e2e/
