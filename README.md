...
[![tests](https://img.shields.io/badge/tests-1266%20passing-brightgreen)](#development)
...
by 1266 tests: 1217 default unit/integration/TUI/web smoke tests plus 49
...
# Tests
uv run pytest -q                          # 1217 default tests; skips tests/e2e/
