...
[![tests](https://img.shields.io/badge/tests-1329%20passing-brightgreen)](#development)
...
by 1329 tests: 1277 default unit/integration/TUI/web smoke tests plus 52
...
# Tests
uv run pytest -q                          # 1277 default tests; skips tests/e2e/
