...
[![tests](https://img.shields.io/badge/tests-1079%20passing-brightgreen)](#development)
...
by 1079 tests: 1053 default unit/integration/TUI/web smoke tests plus 26
...
# Tests
uv run pytest -q                          # 1053 default tests; skips tests/e2e/
