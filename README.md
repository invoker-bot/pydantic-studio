...
[![tests](https://img.shields.io/badge/tests-1303%20passing-brightgreen)](#development)
...
by 1303 tests: 1251 default unit/integration/TUI/web smoke tests plus 52
...
# Tests
uv run pytest -q                          # 1251 default tests; skips tests/e2e/
