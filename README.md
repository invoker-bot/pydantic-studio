...
[![tests](https://img.shields.io/badge/tests-1011%20passing-brightgreen)](#development)
...
by 1011 tests: 988 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 988 default tests; skips tests/e2e/
