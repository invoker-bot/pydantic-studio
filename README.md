...
[![tests](https://img.shields.io/badge/tests-950%20passing-brightgreen)](#development)
...
by 950 tests: 927 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 927 default tests; skips tests/e2e/
