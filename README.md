...
[![tests](https://img.shields.io/badge/tests-1335%20passing-brightgreen)](#development)
...
by 1335 tests: 1283 default unit/integration/TUI/web smoke tests plus 52
...
# Tests
uv run pytest -q                          # 1283 default tests; skips tests/e2e/
