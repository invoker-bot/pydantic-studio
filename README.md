...
[![tests](https://img.shields.io/badge/tests-1056%20passing-brightgreen)](#development)
...
by 1056 tests: 1032 default unit/integration/TUI/web smoke tests plus 24
...
# Tests
uv run pytest -q                          # 1032 default tests; skips tests/e2e/
