...
[![tests](https://img.shields.io/badge/tests-1087%20passing-brightgreen)](#development)
...
by 1087 tests: 1061 default unit/integration/TUI/web smoke tests plus 26
...
# Tests
uv run pytest -q                          # 1061 default tests; skips tests/e2e/
