...
[![tests](https://img.shields.io/badge/tests-842%20passing-brightgreen)](#development)
...
by 842 tests: 819 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 819 default tests; skips tests/e2e/
