...
[![tests](https://img.shields.io/badge/tests-1193%20passing-brightgreen)](#development)
...
by 1193 tests: 1160 default unit/integration/TUI/web smoke tests plus 33
...
# Tests
uv run pytest -q                          # 1160 default tests; skips tests/e2e/
