...
[![tests](https://img.shields.io/badge/tests-1293%20passing-brightgreen)](#development)
...
by 1293 tests: 1242 default unit/integration/TUI/web smoke tests plus 51
...
# Tests
uv run pytest -q                          # 1242 default tests; skips tests/e2e/
