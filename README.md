...
[![tests](https://img.shields.io/badge/tests-1005%20passing-brightgreen)](#development)
...
by 1005 tests: 982 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 982 default tests; skips tests/e2e/
