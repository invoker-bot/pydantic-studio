...
[![tests](https://img.shields.io/badge/tests-1138%20passing-brightgreen)](#development)
...
by 1138 tests: 1105 default unit/integration/TUI/web smoke tests plus 33
...
# Tests
uv run pytest -q                          # 1105 default tests; skips tests/e2e/
