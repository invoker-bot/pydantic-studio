...
[![tests](https://img.shields.io/badge/tests-1364%20passing-brightgreen)](#development)
...
by 1364 tests: 1312 default unit/integration/TUI/web smoke tests plus 52
...
# Tests
uv run pytest -q                          # 1312 default tests; skips tests/e2e/
