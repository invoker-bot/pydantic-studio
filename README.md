...
[![tests](https://img.shields.io/badge/tests-1171%20passing-brightgreen)](#development)
...
by 1171 tests: 1138 default unit/integration/TUI/web smoke tests plus 33
...
# Tests
uv run pytest -q                          # 1138 default tests; skips tests/e2e/
