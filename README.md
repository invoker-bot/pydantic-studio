...
[![tests](https://img.shields.io/badge/tests-846%20passing-brightgreen)](#development)
...
by 846 tests: 823 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 823 default tests; skips tests/e2e/
