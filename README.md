...
[![tests](https://img.shields.io/badge/tests-1169%20passing-brightgreen)](#development)
...
by 1169 tests: 1136 default unit/integration/TUI/web smoke tests plus 33
...
# Tests
uv run pytest -q                          # 1136 default tests; skips tests/e2e/
