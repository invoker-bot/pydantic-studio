...
[![tests](https://img.shields.io/badge/tests-1287%20passing-brightgreen)](#development)
...
by 1287 tests: 1236 default unit/integration/TUI/web smoke tests plus 51
...
# Tests
uv run pytest -q                          # 1236 default tests; skips tests/e2e/
