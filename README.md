...
[![tests](https://img.shields.io/badge/tests-1047%20passing-brightgreen)](#development)
...
by 1047 tests: 1023 default unit/integration/TUI/web smoke tests plus 24
...
# Tests
uv run pytest -q                          # 1023 default tests; skips tests/e2e/
