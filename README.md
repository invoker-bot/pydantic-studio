...
[![tests](https://img.shields.io/badge/tests-1314%20passing-brightgreen)](#development)
...
by 1314 tests: 1262 default unit/integration/TUI/web smoke tests plus 52
...
# Tests
uv run pytest -q                          # 1262 default tests; skips tests/e2e/
