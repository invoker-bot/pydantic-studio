...
[![tests](https://img.shields.io/badge/tests-1099%20passing-brightgreen)](#development)
...
by 1099 tests: 1073 default unit/integration/TUI/web smoke tests plus 26
...
# Tests
uv run pytest -q                          # 1073 default tests; skips tests/e2e/
