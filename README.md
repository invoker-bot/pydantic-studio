...
[![tests](https://img.shields.io/badge/tests-828%20passing-brightgreen)](#development)
...
by 828 tests: 805 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 805 default tests; skips tests/e2e/
