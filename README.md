...
[![tests](https://img.shields.io/badge/tests-999%20passing-brightgreen)](#development)
...
by 999 tests: 976 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 976 default tests; skips tests/e2e/
