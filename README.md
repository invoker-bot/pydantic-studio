...
[![tests](https://img.shields.io/badge/tests-997%20passing-brightgreen)](#development)
...
by 997 tests: 974 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 974 default tests; skips tests/e2e/
