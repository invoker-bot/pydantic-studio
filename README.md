...
[![tests](https://img.shields.io/badge/tests-900%20passing-brightgreen)](#development)
...
by 900 tests: 877 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 877 default tests; skips tests/e2e/
