...
[![tests](https://img.shields.io/badge/tests-1348%20passing-brightgreen)](#development)
...
by 1348 tests: 1296 default unit/integration/TUI/web smoke tests plus 52
...
# Tests
uv run pytest -q                          # 1296 default tests; skips tests/e2e/
