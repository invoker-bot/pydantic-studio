...
[![tests](https://img.shields.io/badge/tests-1013%20passing-brightgreen)](#development)
...
by 1013 tests: 990 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 990 default tests; skips tests/e2e/
