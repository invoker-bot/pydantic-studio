...
[![tests](https://img.shields.io/badge/tests-1097%20passing-brightgreen)](#development)
...
by 1097 tests: 1071 default unit/integration/TUI/web smoke tests plus 26
...
# Tests
uv run pytest -q                          # 1071 default tests; skips tests/e2e/
