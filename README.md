...
[![tests](https://img.shields.io/badge/tests-989%20passing-brightgreen)](#development)
...
by 989 tests: 966 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 966 default tests; skips tests/e2e/
