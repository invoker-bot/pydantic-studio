...
[![tests](https://img.shields.io/badge/tests-1002%20passing-brightgreen)](#development)
...
by 1002 tests: 979 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 979 default tests; skips tests/e2e/
