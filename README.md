...
[![tests](https://img.shields.io/badge/tests-1130%20passing-brightgreen)](#development)
...
by 1130 tests: 1097 default unit/integration/TUI/web smoke tests plus 33
...
# Tests
uv run pytest -q                          # 1097 default tests; skips tests/e2e/
