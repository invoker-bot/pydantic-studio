...
[![tests](https://img.shields.io/badge/tests-899%20passing-brightgreen)](#development)
...
by 899 tests: 876 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 876 default tests; skips tests/e2e/
