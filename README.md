...
[![tests](https://img.shields.io/badge/tests-889%20passing-brightgreen)](#development)
...
by 889 tests: 866 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 866 default tests; skips tests/e2e/
