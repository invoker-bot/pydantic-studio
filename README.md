...
[![tests](https://img.shields.io/badge/tests-1032%20passing-brightgreen)](#development)
...
by 1032 tests: 1008 default unit/integration/TUI/web smoke tests plus 24
...
# Tests
uv run pytest -q                          # 1008 default tests; skips tests/e2e/
