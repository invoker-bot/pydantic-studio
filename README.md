...
[![tests](https://img.shields.io/badge/tests-1302%20passing-brightgreen)](#development)
...
by 1302 tests: 1250 default unit/integration/TUI/web smoke tests plus 52
...
# Tests
uv run pytest -q                          # 1250 default tests; skips tests/e2e/
