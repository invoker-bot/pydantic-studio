...
[![tests](https://img.shields.io/badge/tests-1221%20passing-brightgreen)](#development)
...
by 1221 tests: 1188 default unit/integration/TUI/web smoke tests plus 33
...
# Tests
uv run pytest -q                          # 1188 default tests; skips tests/e2e/
...
uv run python -m pytest tests/e2e -p playwright -o "addopts=-ra"    # 26 browser tests
```
