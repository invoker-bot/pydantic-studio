...
[![tests](https://img.shields.io/badge/tests-1336%20passing-brightgreen)](#development)
...
by 1336 tests: 1284 default unit/integration/TUI/web smoke tests plus 52
...
# Tests
uv run pytest -q                          # 1284 default tests; skips tests/e2e/
