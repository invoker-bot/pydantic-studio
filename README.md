...
[![tests](https://img.shields.io/badge/tests-1108%20passing-brightgreen)](#development)
...
by 1108 tests: 1077 default unit/integration/TUI/web smoke tests plus 31
...
# Tests
uv run pytest -q                          # 1077 default tests; skips tests/e2e/
