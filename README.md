...
[![tests](https://img.shields.io/badge/tests-1125%20passing-brightgreen)](#development)
...
by 1125 tests: 1092 default unit/integration/TUI/web smoke tests plus 33
...
# Tests
uv run pytest -q                          # 1092 default tests; skips tests/e2e/
