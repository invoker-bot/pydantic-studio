...
[![tests](https://img.shields.io/badge/tests-840%20passing-brightgreen)](#development)
...
by 840 tests: 817 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 817 default tests; skips tests/e2e/
