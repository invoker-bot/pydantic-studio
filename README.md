...
[![tests](https://img.shields.io/badge/tests-920%20passing-brightgreen)](#development)
...
by 920 tests: 897 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 897 default tests; skips tests/e2e/
