...
[![tests](https://img.shields.io/badge/tests-1353%20passing-brightgreen)](#development)
...
by 1353 tests: 1301 default unit/integration/TUI/web smoke tests plus 52
...
# Tests
uv run pytest -q                          # 1301 default tests; skips tests/e2e/
