...
[![tests](https://img.shields.io/badge/tests-826%20passing-brightgreen)](#development)
...
by 826 tests: 803 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 803 default tests; skips tests/e2e/
