...
[![tests](https://img.shields.io/badge/tests-1052%20passing-brightgreen)](#development)
...
by 1052 tests: 1028 default unit/integration/TUI/web smoke tests plus 24
...
# Tests
uv run pytest -q                          # 1028 default tests; skips tests/e2e/
