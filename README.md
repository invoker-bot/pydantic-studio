...
[![tests](https://img.shields.io/badge/tests-908%20passing-brightgreen)](#development)
...
by 908 tests: 885 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 885 default tests; skips tests/e2e/
