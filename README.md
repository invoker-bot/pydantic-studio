...
[![tests](https://img.shields.io/badge/tests-821%20passing-brightgreen)](#development)
...
by 821 tests: 798 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 798 default tests; skips tests/e2e/
