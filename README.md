...
[![tests](https://img.shields.io/badge/tests-1320%20passing-brightgreen)](#development)
...
by 1320 tests: 1268 default unit/integration/TUI/web smoke tests plus 52
...
# Tests
uv run pytest -q                          # 1268 default tests; skips tests/e2e/
