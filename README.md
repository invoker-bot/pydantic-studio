...
[![tests](https://img.shields.io/badge/tests-1023%20passing-brightgreen)](#development)
...
by 1023 tests: 999 default unit/integration/TUI/web smoke tests plus 24
...
# Tests
uv run pytest -q                          # 999 default tests; skips tests/e2e/
