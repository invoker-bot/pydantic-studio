...
[![tests](https://img.shields.io/badge/tests-975%20passing-brightgreen)](#development)
...
by 975 tests: 952 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 952 default tests; skips tests/e2e/
