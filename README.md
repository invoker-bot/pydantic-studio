...
[![tests](https://img.shields.io/badge/tests-1121%20passing-brightgreen)](#development)
...
by 1121 tests: 1088 default unit/integration/TUI/web smoke tests plus 33
...
# Tests
uv run pytest -q                          # 1088 default tests; skips tests/e2e/
