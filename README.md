...
[![tests](https://img.shields.io/badge/tests-1134%20passing-brightgreen)](#development)
...
by 1134 tests: 1101 default unit/integration/TUI/web smoke tests plus 33
...
# Tests
uv run pytest -q                          # 1101 default tests; skips tests/e2e/
