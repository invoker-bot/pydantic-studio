...
[![tests](https://img.shields.io/badge/tests-1359%20passing-brightgreen)](#development)
...
by 1359 tests: 1307 default unit/integration/TUI/web smoke tests plus 52
...
# Tests
uv run pytest -q                          # 1307 default tests; skips tests/e2e/
