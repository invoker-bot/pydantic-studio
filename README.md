...
[![tests](https://img.shields.io/badge/tests-1305%20passing-brightgreen)](#development)
...
by 1305 tests: 1253 default unit/integration/TUI/web smoke tests plus 52
...
# Tests
uv run pytest -q                          # 1253 default tests; skips tests/e2e/
