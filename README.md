...
[![tests](https://img.shields.io/badge/tests-1273%20passing-brightgreen)](#development)
...
by 1273 tests: 1222 default unit/integration/TUI/web smoke tests plus 51
...
# Tests
uv run pytest -q                          # 1222 default tests; skips tests/e2e/
