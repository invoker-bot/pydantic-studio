...
[![tests](https://img.shields.io/badge/tests-1049%20passing-brightgreen)](#development)
...
by 1049 tests: 1025 default unit/integration/TUI/web smoke tests plus 24
...
# Tests
uv run pytest -q                          # 1025 default tests; skips tests/e2e/
