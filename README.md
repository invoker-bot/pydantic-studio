...
[![tests](https://img.shields.io/badge/tests-1070%20passing-brightgreen)](#development)
...
by 1070 tests: 1046 default unit/integration/TUI/web smoke tests plus 24
...
# Tests
uv run pytest -q                          # 1046 default tests; skips tests/e2e/
