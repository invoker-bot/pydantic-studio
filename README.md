...
[![tests](https://img.shields.io/badge/tests-1109%20passing-brightgreen)](#development)
...
by 1109 tests: 1078 default unit/integration/TUI/web smoke tests plus 31
...
# Tests
uv run pytest -q                          # 1078 default tests; skips tests/e2e/
