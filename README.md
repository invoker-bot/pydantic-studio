...
[![tests](https://img.shields.io/badge/tests-1242%20passing-brightgreen)](#development)
...
by 1242 tests: 1209 default unit/integration/TUI/web smoke tests plus 33
...
# Tests
uv run pytest -q                          # 1209 default tests; skips tests/e2e/
