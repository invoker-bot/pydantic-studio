...
[![tests](https://img.shields.io/badge/tests-1345%20passing-brightgreen)](#development)
...
by 1345 tests: 1293 default unit/integration/TUI/web smoke tests plus 52
...
# Tests
uv run pytest -q                          # 1293 default tests; skips tests/e2e/
...
uv run python -m pytest tests/e2e -p playwright -o "addopts=-ra"    # 52 browser tests
```
