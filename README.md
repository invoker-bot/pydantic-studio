...
[![tests](https://img.shields.io/badge/tests-1299%20passing-brightgreen)](#development)
...
by 1299 tests: 1248 default unit/integration/TUI/web smoke tests plus 51
...
# Tests
uv run pytest -q                          # 1248 default tests; skips tests/e2e/
