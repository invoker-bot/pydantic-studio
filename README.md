...
[![tests](https://img.shields.io/badge/tests-1150%20passing-brightgreen)](#development)
...
by 1150 tests: 1117 default unit/integration/TUI/web smoke tests plus 33
...
# Tests
uv run pytest -q                          # 1117 default tests; skips tests/e2e/
