...
[![tests](https://img.shields.io/badge/tests-1226%20passing-brightgreen)](#development)
...
by 1226 tests: 1193 default unit/integration/TUI/web smoke tests plus 33
...
# Tests
uv run pytest -q                          # 1193 default tests; skips tests/e2e/
