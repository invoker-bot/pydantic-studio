...
[![tests](https://img.shields.io/badge/tests-834%20passing-brightgreen)](#development)
...
by 834 tests: 811 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 811 default tests; skips tests/e2e/
