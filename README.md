...
[![tests](https://img.shields.io/badge/tests-947%20passing-brightgreen)](#development)
...
by 947 tests: 924 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 924 default tests; skips tests/e2e/
