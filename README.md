...
[![tests](https://img.shields.io/badge/tests-1057%20passing-brightgreen)](#development)
...
by 1057 tests: 1033 default unit/integration/TUI/web smoke tests plus 24
...
# Tests
uv run pytest -q                          # 1033 default tests; skips tests/e2e/
...
uv run python -m pytest tests/e2e -p playwright -o "addopts=-ra"    # 24 browser tests
```
