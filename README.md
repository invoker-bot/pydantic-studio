...
[![tests](https://img.shields.io/badge/tests-1173%20passing-brightgreen)](#development)
...
by 1173 tests: 1140 default unit/integration/TUI/web smoke tests plus 33
...
# Tests
uv run pytest -q                          # 1140 default tests; skips tests/e2e/
