...
[![tests](https://img.shields.io/badge/tests-1064%20passing-brightgreen)](#development)
...
by 1064 tests: 1040 default unit/integration/TUI/web smoke tests plus 24
...
# Tests
uv run pytest -q                          # 1040 default tests; skips tests/e2e/
