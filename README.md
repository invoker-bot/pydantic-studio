...
[![tests](https://img.shields.io/badge/tests-913%20passing-brightgreen)](#development)
...
by 913 tests: 890 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 890 default tests; skips tests/e2e/
