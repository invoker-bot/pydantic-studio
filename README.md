...
[![tests](https://img.shields.io/badge/tests-824%20passing-brightgreen)](#development)
...
by 824 tests: 801 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 801 default tests; skips tests/e2e/
