...
[![tests](https://img.shields.io/badge/tests-822%20passing-brightgreen)](#development)
...
by 822 tests: 799 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 799 default tests; skips tests/e2e/
