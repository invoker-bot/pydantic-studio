...
[![tests](https://img.shields.io/badge/tests-966%20passing-brightgreen)](#development)
...
by 966 tests: 943 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 943 default tests; skips tests/e2e/
