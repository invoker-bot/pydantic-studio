...
[![tests](https://img.shields.io/badge/tests-1085%20passing-brightgreen)](#development)
...
by 1085 tests: 1059 default unit/integration/TUI/web smoke tests plus 26
...
# Tests
uv run pytest -q                          # 1059 default tests; skips tests/e2e/
