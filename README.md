...
[![tests](https://img.shields.io/badge/tests-879%20passing-brightgreen)](#development)
...
by 879 tests: 856 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 856 default tests; skips tests/e2e/
