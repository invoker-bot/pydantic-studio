...
[![tests](https://img.shields.io/badge/tests-949%20passing-brightgreen)](#development)
...
by 949 tests: 926 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 926 default tests; skips tests/e2e/
