...
[![tests](https://img.shields.io/badge/tests-818%20passing-brightgreen)](#development)
...
by 818 tests: 795 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 795 default tests; skips tests/e2e/
