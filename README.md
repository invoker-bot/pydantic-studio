...
[![tests](https://img.shields.io/badge/tests-1044%20passing-brightgreen)](#development)
...
by 1044 tests: 1020 default unit/integration/TUI/web smoke tests plus 24
...
# Tests
uv run pytest -q                          # 1020 default tests; skips tests/e2e/
