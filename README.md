...
[![tests](https://img.shields.io/badge/tests-1300%20passing-brightgreen)](#development)
...
by 1300 tests: 1249 default unit/integration/TUI/web smoke tests plus 51
...
# Tests
uv run pytest -q                          # 1249 default tests; skips tests/e2e/
