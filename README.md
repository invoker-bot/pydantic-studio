...
[![tests](https://img.shields.io/badge/tests-1008%20passing-brightgreen)](#development)
...
by 1008 tests: 985 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 985 default tests; skips tests/e2e/
