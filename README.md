...
[![tests](https://img.shields.io/badge/tests-1247%20passing-brightgreen)](#development)
...
by 1247 tests: 1212 default unit/integration/TUI/web smoke tests plus 35
...
uv run python -m pytest tests/e2e -p playwright -o "addopts=-ra"    # 35 browser tests
```
