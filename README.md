...
[![tests](https://img.shields.io/badge/tests-960%20passing-brightgreen)](#development)
...
by 960 tests: 937 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 937 default tests; skips tests/e2e/
