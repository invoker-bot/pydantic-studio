...
[![tests](https://img.shields.io/badge/tests-837%20passing-brightgreen)](#development)
...
by 837 tests: 814 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 814 default tests; skips tests/e2e/
