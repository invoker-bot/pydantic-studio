...
[![tests](https://img.shields.io/badge/tests-1235%20passing-brightgreen)](#development)
...
by 1235 tests: 1202 default unit/integration/TUI/web smoke tests plus 33
...
# Tests
uv run pytest -q                          # 1202 default tests; skips tests/e2e/
