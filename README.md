...
[![tests](https://img.shields.io/badge/tests-832%20passing-brightgreen)](#development)
...
by 832 tests: 809 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 809 default tests; skips tests/e2e/
