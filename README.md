...
[![tests](https://img.shields.io/badge/tests-1159%20passing-brightgreen)](#development)
...
by 1159 tests: 1126 default unit/integration/TUI/web smoke tests plus 33
...
# Tests
uv run pytest -q                          # 1126 default tests; skips tests/e2e/
