...
[![tests](https://img.shields.io/badge/tests-844%20passing-brightgreen)](#development)
...
by 844 tests: 821 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 821 default tests; skips tests/e2e/
