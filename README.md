...
[![tests](https://img.shields.io/badge/tests-823%20passing-brightgreen)](#development)
...
by 823 tests: 800 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 800 default tests; skips tests/e2e/
