...
[![tests](https://img.shields.io/badge/tests-1086%20passing-brightgreen)](#development)
...
by 1086 tests: 1060 default unit/integration/TUI/web smoke tests plus 26
...
# Tests
uv run pytest -q                          # 1060 default tests; skips tests/e2e/
