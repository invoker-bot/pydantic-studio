...
[![tests](https://img.shields.io/badge/tests-1338%20passing-brightgreen)](#development)
...
by 1338 tests: 1286 default unit/integration/TUI/web smoke tests plus 52
...
# Tests
uv run pytest -q                          # 1286 default tests; skips tests/e2e/
