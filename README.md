...
[![tests](https://img.shields.io/badge/tests-1210%20passing-brightgreen)](#development)
...
by 1210 tests: 1177 default unit/integration/TUI/web smoke tests plus 33
...
# Tests
uv run pytest -q                          # 1177 default tests; skips tests/e2e/
