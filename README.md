...
[![tests](https://img.shields.io/badge/tests-841%20passing-brightgreen)](#development)
...
by 841 tests: 818 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 818 default tests; skips tests/e2e/
