...
[![tests](https://img.shields.io/badge/tests-926%20passing-brightgreen)](#development)
...
by 926 tests: 903 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 903 default tests; skips tests/e2e/
