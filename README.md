...
[![tests](https://img.shields.io/badge/tests-1145%20passing-brightgreen)](#development)
...
by 1145 tests: 1112 default unit/integration/TUI/web smoke tests plus 33
...
# Tests
uv run pytest -q                          # 1112 default tests; skips tests/e2e/
