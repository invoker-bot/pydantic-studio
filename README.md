...
[![tests](https://img.shields.io/badge/tests-981%20passing-brightgreen)](#development)
...
by 981 tests: 958 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 958 default tests; skips tests/e2e/
