...
[![tests](https://img.shields.io/badge/tests-1271%20passing-brightgreen)](#development)
...
by 1271 tests: 1220 default unit/integration/TUI/web smoke tests plus 51
...
# Tests
uv run pytest -q                          # 1220 default tests; skips tests/e2e/
