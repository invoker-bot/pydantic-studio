...
[![tests](https://img.shields.io/badge/tests-1285%20passing-brightgreen)](#development)
...
by 1285 tests: 1234 default unit/integration/TUI/web smoke tests plus 51
...
# Tests
uv run pytest -q                          # 1234 default tests; skips tests/e2e/
