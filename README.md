...
[![tests](https://img.shields.io/badge/tests-937%20passing-brightgreen)](#development)
...
by 937 tests: 914 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 914 default tests; skips tests/e2e/
