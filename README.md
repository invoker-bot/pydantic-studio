...
[![tests](https://img.shields.io/badge/tests-1304%20passing-brightgreen)](#development)
...
by 1304 tests: 1252 default unit/integration/TUI/web smoke tests plus 52
...
# Tests
uv run pytest -q                          # 1252 default tests; skips tests/e2e/
