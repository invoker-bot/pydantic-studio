...
[![tests](https://img.shields.io/badge/tests-1019%20passing-brightgreen)](#development)
...
by 1019 tests: 995 default unit/integration/TUI/web smoke tests plus 24
...
# Tests
uv run pytest -q                          # 995 default tests; skips tests/e2e/
