...
[![tests](https://img.shields.io/badge/tests-831%20passing-brightgreen)](#development)
...
by 831 tests: 808 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 808 default tests; skips tests/e2e/
