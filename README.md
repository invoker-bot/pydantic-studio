...
[![tests](https://img.shields.io/badge/tests-830%20passing-brightgreen)](#development)
...
by 830 tests: 807 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 807 default tests; skips tests/e2e/
