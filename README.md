...
[![tests](https://img.shields.io/badge/tests-839%20passing-brightgreen)](#development)
...
by 839 tests: 816 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 816 default tests; skips tests/e2e/
