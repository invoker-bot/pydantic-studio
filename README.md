...
[![tests](https://img.shields.io/badge/tests-819%20passing-brightgreen)](#development)
...
by 819 tests: 796 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 796 default tests; skips tests/e2e/
