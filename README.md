...
[![tests](https://img.shields.io/badge/tests-927%20passing-brightgreen)](#development)
...
by 927 tests: 904 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 904 default tests; skips tests/e2e/
