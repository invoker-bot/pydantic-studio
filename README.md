...
[![tests](https://img.shields.io/badge/tests-833%20passing-brightgreen)](#development)
...
by 833 tests: 810 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 810 default tests; skips tests/e2e/
