...
[![tests](https://img.shields.io/badge/tests-891%20passing-brightgreen)](#development)
...
by 891 tests: 868 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 868 default tests; skips tests/e2e/
