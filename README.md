...
[![tests](https://img.shields.io/badge/tests-1001%20passing-brightgreen)](#development)
...
by 1001 tests: 978 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 978 default tests; skips tests/e2e/
