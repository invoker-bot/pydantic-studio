...
[![tests](https://img.shields.io/badge/tests-1021%20passing-brightgreen)](#development)
...
by 1021 tests: 997 default unit/integration/TUI/web smoke tests plus 24
...
# Tests
uv run pytest -q                          # 997 default tests; skips tests/e2e/
