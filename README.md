...
[![tests](https://img.shields.io/badge/tests-1080%20passing-brightgreen)](#development)
...
by 1080 tests: 1054 default unit/integration/TUI/web smoke tests plus 26
...
# Tests
uv run pytest -q                          # 1054 default tests; skips tests/e2e/
