...
[![tests](https://img.shields.io/badge/tests-825%20passing-brightgreen)](#development)
...
by 825 tests: 802 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 802 default tests; skips tests/e2e/
