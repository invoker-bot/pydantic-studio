...
[![tests](https://img.shields.io/badge/tests-1158%20passing-brightgreen)](#development)
...
by 1158 tests: 1125 default unit/integration/TUI/web smoke tests plus 33
...
# Tests
uv run pytest -q                          # 1125 default tests; skips tests/e2e/
