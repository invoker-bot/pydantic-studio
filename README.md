...
[![tests](https://img.shields.io/badge/tests-1230%20passing-brightgreen)](#development)
...
by 1230 tests: 1197 default unit/integration/TUI/web smoke tests plus 33
...
# Tests
uv run pytest -q                          # 1197 default tests; skips tests/e2e/
