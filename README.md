...
[![tests](https://img.shields.io/badge/tests-987%20passing-brightgreen)](#development)
...
by 987 tests: 964 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 964 default tests; skips tests/e2e/
