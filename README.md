...
[![tests](https://img.shields.io/badge/tests-1072%20passing-brightgreen)](#development)
...
by 1072 tests: 1048 default unit/integration/TUI/web smoke tests plus 24
...
# Tests
uv run pytest -q                          # 1048 default tests; skips tests/e2e/
