...
[![tests](https://img.shields.io/badge/tests-1288%20passing-brightgreen)](#development)
...
by 1288 tests: 1237 default unit/integration/TUI/web smoke tests plus 51
...
# Tests
uv run pytest -q                          # 1237 default tests; skips tests/e2e/
