...
[![tests](https://img.shields.io/badge/tests-1078%20passing-brightgreen)](#development)
...
by 1078 tests: 1052 default unit/integration/TUI/web smoke tests plus 26
...
# Tests
uv run pytest -q                          # 1052 default tests; skips tests/e2e/
