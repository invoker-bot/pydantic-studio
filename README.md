...
[![tests](https://img.shields.io/badge/tests-940%20passing-brightgreen)](#development)
...
by 940 tests: 917 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 917 default tests; skips tests/e2e/
