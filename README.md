...
[![tests](https://img.shields.io/badge/tests-1246%20passing-brightgreen)](#development)
...
by 1246 tests: 1212 default unit/integration/TUI/web smoke tests plus 34
...
uv run python -m pytest tests/e2e -p playwright -o "addopts=-ra"    # 34 browser tests
```
