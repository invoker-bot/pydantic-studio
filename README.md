...
[![tests](https://img.shields.io/badge/tests-1286%20passing-brightgreen)](#development)
...
by 1286 tests: 1235 default unit/integration/TUI/web smoke tests plus 51
...
# Tests
uv run pytest -q                          # 1235 default tests; skips tests/e2e/
