...
[![tests](https://img.shields.io/badge/tests-854%20passing-brightgreen)](#development)
...
by 854 tests: 831 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 831 default tests; skips tests/e2e/
