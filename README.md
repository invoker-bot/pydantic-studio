...
[![tests](https://img.shields.io/badge/tests-1116%20passing-brightgreen)](#development)
...
by 1116 tests: 1083 default unit/integration/TUI/web smoke tests plus 33
...
# Tests
uv run pytest -q                          # 1083 default tests; skips tests/e2e/
