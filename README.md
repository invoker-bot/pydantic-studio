...
[![tests](https://img.shields.io/badge/tests-1223%20passing-brightgreen)](#development)
...
by 1223 tests: 1190 default unit/integration/TUI/web smoke tests plus 33
...
# Tests
uv run pytest -q                          # 1190 default tests; skips tests/e2e/
