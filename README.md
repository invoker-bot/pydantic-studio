...
[![tests](https://img.shields.io/badge/tests-1297%20passing-brightgreen)](#development)
...
by 1297 tests: 1246 default unit/integration/TUI/web smoke tests plus 51
...
# Tests
uv run pytest -q                          # 1246 default tests; skips tests/e2e/
