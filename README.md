...
[![tests](https://img.shields.io/badge/tests-1199%20passing-brightgreen)](#development)
...
by 1199 tests: 1166 default unit/integration/TUI/web smoke tests plus 33
...
# Tests
uv run pytest -q                          # 1166 default tests; skips tests/e2e/
