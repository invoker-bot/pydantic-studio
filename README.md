...
[![tests](https://img.shields.io/badge/tests-888%20passing-brightgreen)](#development)
...
by 888 tests: 865 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 865 default tests; skips tests/e2e/
