...
[![tests](https://img.shields.io/badge/tests-958%20passing-brightgreen)](#development)
...
by 958 tests: 935 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 935 default tests; skips tests/e2e/
