...
[![tests](https://img.shields.io/badge/tests-1066%20passing-brightgreen)](#development)
...
by 1066 tests: 1042 default unit/integration/TUI/web smoke tests plus 24
...
# Tests
uv run pytest -q                          # 1042 default tests; skips tests/e2e/
