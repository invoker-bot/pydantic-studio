...
[![tests](https://img.shields.io/badge/tests-1356%20passing-brightgreen)](#development)
...
by 1356 tests: 1304 default unit/integration/TUI/web smoke tests plus 52
...
# Tests
uv run pytest -q                          # 1304 default tests; skips tests/e2e/
