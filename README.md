...
[![tests](https://img.shields.io/badge/tests-1264%20passing-brightgreen)](#development)
...
by 1264 tests: 1215 default unit/integration/TUI/web smoke tests plus 49
...
# Tests
uv run pytest -q                          # 1215 default tests; skips tests/e2e/
