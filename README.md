...
[![tests](https://img.shields.io/badge/tests-1206%20passing-brightgreen)](#development)
...
by 1206 tests: 1173 default unit/integration/TUI/web smoke tests plus 33
...
# Tests
uv run pytest -q                          # 1173 default tests; skips tests/e2e/
