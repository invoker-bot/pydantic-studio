...
[![tests](https://img.shields.io/badge/tests-1257%20passing-brightgreen)](#development)
...
by 1257 tests: 1212 default unit/integration/TUI/web smoke tests plus 45
...
uv run python -m pytest tests/e2e -p playwright -o "addopts=-ra"    # 45 browser tests
```
