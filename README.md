...
[![tests](https://img.shields.io/badge/tests-1012%20passing-brightgreen)](#development)
...
by 1012 tests: 989 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 989 default tests; skips tests/e2e/
