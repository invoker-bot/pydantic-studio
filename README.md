...
[![tests](https://img.shields.io/badge/tests-886%20passing-brightgreen)](#development)
...
by 886 tests: 863 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 863 default tests; skips tests/e2e/
