...
[![tests](https://img.shields.io/badge/tests-983%20passing-brightgreen)](#development)
...
by 983 tests: 960 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 960 default tests; skips tests/e2e/
