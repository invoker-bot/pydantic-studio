...
[![tests](https://img.shields.io/badge/tests-1277%20passing-brightgreen)](#development)
...
by 1277 tests: 1226 default unit/integration/TUI/web smoke tests plus 51
...
# Tests
uv run pytest -q                          # 1226 default tests; skips tests/e2e/
