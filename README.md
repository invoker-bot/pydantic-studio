...
[![tests](https://img.shields.io/badge/tests-1190%20passing-brightgreen)](#development)
...
by 1190 tests: 1157 default unit/integration/TUI/web smoke tests plus 33
...
# Tests
uv run pytest -q                          # 1157 default tests; skips tests/e2e/
