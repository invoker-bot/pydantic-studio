...
[![tests](https://img.shields.io/badge/tests-1256%20passing-brightgreen)](#development)
...
by 1256 tests: 1212 default unit/integration/TUI/web smoke tests plus 44
...
uv run python -m pytest tests/e2e -p playwright -o "addopts=-ra"    # 44 browser tests
```
