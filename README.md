...
[![tests](https://img.shields.io/badge/tests-962%20passing-brightgreen)](#development)
...
by 962 tests: 939 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 939 default tests; skips tests/e2e/
