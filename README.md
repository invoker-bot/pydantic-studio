...
[![tests](https://img.shields.io/badge/tests-957%20passing-brightgreen)](#development)
...
by 957 tests: 934 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 934 default tests; skips tests/e2e/
