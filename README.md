...
[![tests](https://img.shields.io/badge/tests-1006%20passing-brightgreen)](#development)
...
by 1006 tests: 983 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 983 default tests; skips tests/e2e/
