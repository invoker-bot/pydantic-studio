...
[![tests](https://img.shields.io/badge/tests-1062%20passing-brightgreen)](#development)
...
by 1062 tests: 1038 default unit/integration/TUI/web smoke tests plus 24
...
# Tests
uv run pytest -q                          # 1038 default tests; skips tests/e2e/
