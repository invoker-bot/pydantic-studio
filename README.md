...
[![tests](https://img.shields.io/badge/tests-1347%20passing-brightgreen)](#development)
...
by 1347 tests: 1295 default unit/integration/TUI/web smoke tests plus 52
...
# Tests
uv run pytest -q                          # 1295 default tests; skips tests/e2e/
