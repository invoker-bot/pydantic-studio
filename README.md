...
[![tests](https://img.shields.io/badge/tests-1265%20passing-brightgreen)](#development)
...
by 1265 tests: 1216 default unit/integration/TUI/web smoke tests plus 49
...
# Tests
uv run pytest -q                          # 1216 default tests; skips tests/e2e/
...
uv run python -m pytest tests/e2e -p playwright -o "addopts=-ra"    # 49 browser tests
```
