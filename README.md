...
[![tests](https://img.shields.io/badge/tests-1323%20passing-brightgreen)](#development)
...
by 1323 tests: 1271 default unit/integration/TUI/web smoke tests plus 52
...
# Tests
uv run pytest -q                          # 1271 default tests; skips tests/e2e/
