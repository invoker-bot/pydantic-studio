...
[![tests](https://img.shields.io/badge/tests-1074%20passing-brightgreen)](#development)
...
by 1074 tests: 1050 default unit/integration/TUI/web smoke tests plus 24
...
# Tests
uv run pytest -q                          # 1050 default tests; skips tests/e2e/
