...
[![tests](https://img.shields.io/badge/tests-1028%20passing-brightgreen)](#development)
...
by 1028 tests: 1004 default unit/integration/TUI/web smoke tests plus 24
...
# Tests
uv run pytest -q                          # 1004 default tests; skips tests/e2e/
