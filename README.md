...
[![tests](https://img.shields.io/badge/tests-847%20passing-brightgreen)](#development)
...
by 847 tests: 824 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 824 default tests; skips tests/e2e/
