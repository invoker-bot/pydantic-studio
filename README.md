...
[![tests](https://img.shields.io/badge/tests-976%20passing-brightgreen)](#development)
...
by 976 tests: 953 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 953 default tests; skips tests/e2e/
