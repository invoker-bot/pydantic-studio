...
[![tests](https://img.shields.io/badge/tests-1081%20passing-brightgreen)](#development)
...
by 1081 tests: 1055 default unit/integration/TUI/web smoke tests plus 26
...
# Tests
uv run pytest -q                          # 1055 default tests; skips tests/e2e/
