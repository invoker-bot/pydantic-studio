...
[![tests](https://img.shields.io/badge/tests-1103%20passing-brightgreen)](#development)
...
by 1103 tests: 1074 default unit/integration/TUI/web smoke tests plus 29
...
# Tests
uv run pytest -q                          # 1074 default tests; skips tests/e2e/
