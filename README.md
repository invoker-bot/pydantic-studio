...
[![tests](https://img.shields.io/badge/tests-852%20passing-brightgreen)](#development)
...
by 852 tests: 829 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 829 default tests; skips tests/e2e/
