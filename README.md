...
[![tests](https://img.shields.io/badge/tests-851%20passing-brightgreen)](#development)
...
by 851 tests: 828 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 828 default tests; skips tests/e2e/
