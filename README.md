...
[![tests](https://img.shields.io/badge/tests-923%20passing-brightgreen)](#development)
...
by 923 tests: 900 default unit/integration/TUI/web smoke tests plus 23
...
# Tests
uv run pytest -q                          # 900 default tests; skips tests/e2e/
