...
[![tests](https://img.shields.io/badge/tests-1255%20passing-brightgreen)](#development)
...
by 1255 tests: 1212 default unit/integration/TUI/web smoke tests plus 43
...
uv run python -m pytest tests/e2e -p playwright -o "addopts=-ra"    # 43 browser tests
```
