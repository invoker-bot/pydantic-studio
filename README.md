...
[![tests](https://img.shields.io/badge/tests-1295%20passing-brightgreen)](#development)
...
by 1295 tests: 1244 default unit/integration/TUI/web smoke tests plus 51
...
# Tests
uv run pytest -q                          # 1244 default tests; skips tests/e2e/
...
uv run python -m pytest tests/e2e -p playwright -o "addopts=-ra"    # 51 browser tests
```
