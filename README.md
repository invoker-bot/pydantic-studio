...
[![tests](https://img.shields.io/badge/tests-1160%20passing-brightgreen)](#development)
...
by 1160 tests: 1127 default unit/integration/TUI/web smoke tests plus 33
...
# Tests
uv run pytest -q                          # 1127 default tests; skips tests/e2e/
