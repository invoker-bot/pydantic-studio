...
def test_reset_is_idempotent() -> None:
    ...
    # Default registry registers 12 builders: String, Int, Float, Bool, Decimal,
    # Enum, Literal, List, Set, Tuple, Dict, Group. Double-reset must produce the same baseline.
    assert len(reg) == 12
