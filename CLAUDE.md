...
- **Status**: v0.4.0 alpha — all 9 implementation phases, the
  ...
  root model variants are merged on master. Current local gate: 1292
  tests: 1241 default tests plus 51 explicit Playwright browser e2e tests, ruff
...
- **`uv run pytest -q`** runs the default suite (1241 tests currently).
