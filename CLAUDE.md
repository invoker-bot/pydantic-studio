...
- **Status**: v0.4.0 alpha — all 9 implementation phases, the
  ...
  root model variants are merged on master. Current local gate: 1014
  tests: 991 default tests plus 23 explicit Playwright browser e2e tests, ruff
...
- **`uv run pytest -q`** runs the default suite (991 tests at v0.4.0).
