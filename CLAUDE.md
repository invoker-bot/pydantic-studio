...
- **Status**: v0.4.0 alpha — all 9 implementation phases, the
  ...
  root model variants are merged on master. Current local gate: 1087
  tests: 1061 default tests plus 26 explicit Playwright browser e2e tests, ruff
...
- **`uv run pytest -q`** runs the default suite (1061 tests at v0.4.0).
