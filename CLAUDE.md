...
- **Status**: v0.4.0 alpha — all 9 implementation phases, the
  ...
  root model variants are merged on master. Current local gate: 1064
  tests: 1040 default tests plus 24 explicit Playwright browser e2e tests, ruff
...
- **`uv run pytest -q`** runs the default suite (1040 tests at v0.4.0).
