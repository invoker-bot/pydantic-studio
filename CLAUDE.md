...
- **Status**: v0.4.0 alpha — all 9 implementation phases, the
  ...
  root model variants are merged on master. Current local gate: 1002
  tests: 979 default tests plus 23 explicit Playwright browser e2e tests, ruff
...
- **`uv run pytest -q`** runs the default suite (979 tests at v0.4.0).
