...
- **Status**: v0.4.0 alpha — all 9 implementation phases, the
  ...
  root model variants are merged on master. Current local gate: 1104
  tests: 1074 default tests plus 30 explicit Playwright browser e2e tests, ruff
...
- **`uv run pytest -q`** runs the default suite (1074 tests at v0.4.0).
