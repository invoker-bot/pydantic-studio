...
- **Status**: v0.4.0 alpha — all 9 implementation phases, the
  ...
  root model variants are merged on master. Current local gate: 1276
  tests: 1225 default tests plus 51 explicit Playwright browser e2e tests, ruff
...
- **`uv run pytest -q`** runs the default suite (1225 tests currently).
