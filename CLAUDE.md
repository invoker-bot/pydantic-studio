...
- **Status**: v0.4.0 alpha — all 9 implementation phases, the
  ...
  root model variants are merged on master. Current local gate: 1130
  tests: 1097 default tests plus 33 explicit Playwright browser e2e tests, ruff
...
- **`uv run pytest -q`** runs the default suite (1097 tests at v0.4.0).
