...
- **Status**: v0.4.0 alpha — all 9 implementation phases, the
  ...
  root model variants are merged on master. Current local gate: 1032
  tests: 1008 default tests plus 24 explicit Playwright browser e2e tests, ruff
...
- **`uv run pytest -q`** runs the default suite (1008 tests at v0.4.0).
